...
filename = "final-measurements/etcd-data/old-faults/4096-L-C-etcd_2023-11-12T06-27-32.csv"
# if len(sys.argv) != 2:
...
# ax.set_ylim(0, ax.get_ylim()[1])
plt.savefig("final-thesis-figures/latency_leader_crash_4096_client_etcd.pdf", bbox_inches='tight', pad_inches=0.05)
plt.show()
plt.clf()
