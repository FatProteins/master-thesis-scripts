...
filename = "final-measurements/bftsmart-data/next-old-faults/1024-A-C-bftsmart_2023-11-12T09:15:42.905365419.csv"
# if len(sys.argv) != 2:
...
ax.text(18, ax.get_ylim()[1]/2, 'Leader\nCrash', color='r')
ax.axvline(35, color='b', linestyle='--', zorder=2, lw=2)
ax.text(36, ax.get_ylim()[1]/2, 'Crashed Leader\nRejoins\nAs Follower', color='b')
ax.axvline(26, color='darkorange', linestyle='--', zorder=2, lw=2)
ax.text(27, ax.get_ylim()[1]/2, 'New\nLeader\nElected', color='darkorange')
...
# ax.set_ylim(0, ax.get_ylim()[1])
plt.savefig("final-thesis-figures/latency_leader_crash_1024_client_bftsmart.pdf", bbox_inches='tight', pad_inches=0.05)
plt.show()
plt.clf()
