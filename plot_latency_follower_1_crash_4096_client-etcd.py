...
filename = "final-measurements/etcd-data/old-faults/4096-F-C-etcd_2023-11-12T06-31-35.csv"
# if len(sys.argv) != 2:
...
ax.set_yticks(np.arange(0, ax.get_ylim()[1]+10000, 10000))

# ax.set_xlim(0, ax.get_xlim()[1])
ax.set_xlim(0, 60)
# ax.set_ylim(0, ax.get_ylim()[1])
plt.savefig("final-thesis-figures/latency_follower_crash_4096_client_etcd.pdf", bbox_inches='tight', pad_inches=0.05)
plt.show()
plt.clf()
