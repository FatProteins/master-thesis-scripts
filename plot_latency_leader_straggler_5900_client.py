...
ax.axvline(25, ymax=0.2, color='m', linestyle='--', zorder=1)
ax.text(26, 10000, 'Leader\nStarts\nStraggling', color='m')
ax.axvline(40, ymax=0.35, color='c', linestyle='--', zorder=1)
ax.text(41, 10000, 'Leader\nStops\nStraggling', color='c')
...
ax.set_yticks(np.arange(0, 600001, 50000))
