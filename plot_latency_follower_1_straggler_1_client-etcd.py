...
filename = "final-measurements/etcd-data/old-faults/1-F-S-etcd_2023-11-12T06-25-32.csv"
# if len(sys.argv) != 2:
...
# ax.set_ylim(0, ax.get_ylim()[1])
plt.savefig(f"final-thesis-figures/latency_follower_straggler_1_client_etcd.pdf", bbox_inches='tight', pad_inches=0.05)
plt.show()
plt.clf()
