...
filename = "data/5900-kv_pairs_2023-11-01T22-54-18-follower_1_straggler_5900_client.csv"
# if len(sys.argv) != 2:
...
ax.axvline(25, ymax=0.92, color='m', linestyle='--', zorder=1)
ax.text(15, 60000, 'Follower\nStarts\nStraggling', color='m')
ax.axvline(40, ymax=0.91, color='c', linestyle='--', zorder=1)
ax.text(41, 60000, 'Follower\nStops\nStraggling', color='c')
...
# ax.set_ylim(0, ax.get_ylim()[1])
plt.savefig(f"latency_follower_1_straggler_{num_clients}_client_right.pdf", bbox_inches='tight', pad_inches=0.05)
plt.show()
plt.clf()
