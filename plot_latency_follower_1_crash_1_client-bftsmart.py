...
filename = "final-measurements/bftsmart-data/old-faults/1-C-C-bftsmart_2023-11-12T05:56:18.482656687.csv"
# if len(sys.argv) != 2:
...
plt.savefig(f"final-thesis-figures/latency_follower_crash_1_client_bftsmart.pdf", bbox_inches='tight', pad_inches=0.05)
plt.show()
plt.clf()
