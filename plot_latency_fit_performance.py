...
plot_performance("fit-measurement/with_fit/4096-kv_pairs_2023-11-06T21-11-39.csv", ax, 'k')
...
# ax.set_ylim(0, ax.get_ylim()[1])
plt.savefig("latency_fit_performance.pdf", bbox_inches='tight', pad_inches=0.05)
plt.show()
plt.clf()
