...
ax.axvline(25, ymax=0.35, color='r', linestyle='--', zorder=1)
ax.text(18, 70, 'Leader\nCrash', color='r')
ax.axvline(36, ymax=0.89, color='b', linestyle='--', zorder=1)
ax.text(37, 285, 'Crashed Leader\nRejoins\nAs Follower', color='b')
ax.axvline(26, ymax=0.25, color='darkorange', linestyle='--', zorder=1)
