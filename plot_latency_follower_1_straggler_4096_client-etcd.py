...
filename = "final-measurements/etcd-data/old-faults/4096-F-S-etcd_2023-11-12T06-33-37.csv"
# if len(sys.argv) != 2:
...
ax.text(15, ax.get_ylim()[1]/2, 'Follower\nStarts\nStraggling', color='m')
ax.axvline(40, color='c', linestyle='--', zorder=2, lw=2)
ax.text(41, ax.get_ylim()[1]/2, 'Follower\nStops\nStraggling', color='c')
...
# ax.set_ylim(0, ax.get_ylim()[1])
plt.savefig("final-thesis-figures/latency_follower_straggler_4096_client_etcd.pdf", bbox_inches='tight', pad_inches=0.05)
plt.show()
plt.clf()
