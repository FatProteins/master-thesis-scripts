...
def plot_performance(filename: str, ax=None):
    ...
    with pd.option_context('display.max_rows', None,
        ...
        # print(second_counts)
        shift_by = 10
        rdf = pd.DataFrame(index=unique[shift_by:-2] - shift_by, data=counts[shift_by:-2]) \
...
filename = "../bftsmart-temp-performance/bftsmart-out/512-bftsmart_2023-11-11T11:37:57.529212640.csv"
# if len(sys.argv) != 2:
