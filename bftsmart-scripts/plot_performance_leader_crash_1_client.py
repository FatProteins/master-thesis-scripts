...
filename = "../bftsmart-performance/leader-crash/1-bftsmart_2023-11-11T09:43:20.132572147.csv"
# if len(sys.argv) != 2:
...
ax.text(18, 70, 'Leader\nCrash', color='r')
ax.axvline(36, color='b', linestyle='--', zorder=1)
ax.text(37, 285, 'Crashed Leader\nRejoins\nAs Follower', color='b')
ax.axvline(26, color='darkorange', linestyle='--', zorder=1)
...
# ax.set_ylim(0, 900)
plt.savefig(f"leader_crash_{num_clients}_client_bftsmart.pdf", bbox_inches='tight', pad_inches=0.05)
plt.show()
plt.clf()
