...
ax.axvline(25, ymax=0.91, color='r', linestyle='--', zorder=1)
ax.text(17, 60000, 'Follower\nCrash', color='r')
ax.axvline(38, ymax=0.78, color='b', linestyle='--', zorder=1)
ax.text(39, 57000, 'Follower\nRejoins\nCluster', color='b')
