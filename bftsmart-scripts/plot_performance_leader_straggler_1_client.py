...
ax.axvline(25, ymin=0.29, ymax=1.0, color='m', linestyle='--', zorder=1)
ax.text(26, 600, 'Leader\nStarts\nStraggling', color='m')
ax.axvline(40, ymax=0.42, color='c', linestyle='--', zorder=1)
ax.text(41, 100, 'Leader\nStops\nStraggling', color='c')
...
ax.set_ylim(0, ax.get_ylim()[1])
plt.savefig(f"leader_straggler_{num_clients}_client_{random.Random().randint(0, 10000)}.pdf", bbox_inches='tight', pad_inches=0.05)
plt.show()
plt.clf()
